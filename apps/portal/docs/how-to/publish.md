...
For a local production-style preview of a published workspace, use the Bun-owned sandbox helper at `orchestrators/bun/resources/deployment/sandbox/docker-compose.yml` with `WEBSTIR_WORKSPACE=/absolute/path/to/workspace`.
