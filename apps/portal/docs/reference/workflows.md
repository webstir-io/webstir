...
- Testing — [tests](../explanations/testing.md) and the [orchestrator testing guide](https://github.com/webstir-io/webstir/blob/main/orchestrators/dotnet/.codex/testing.md)
