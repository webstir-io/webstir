...
- Update developer docs (`README`, [orchestrator testing guide](https://github.com/webstir-io/webstir/blob/main/orchestrators/dotnet/.codex/testing.md), internal runbooks) to reference `Tester` and `dotnet test`.
